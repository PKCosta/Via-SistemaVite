      ...
      <div className="flex flex-col items-center w-full max-w-[460px] space-y-4">
        ...
        <span className="text-lg md:text-xl font-semibold text-gray-100">
          ...
          <Card className=" w-full max-w-[380px] 
                            ...
                            border border-gray-600 shadow-xl bg-gray-800 mt-6 p-2 mt-4">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl className="w-full rounded-md border-gray-400 p-3 br-gray-600">
                          ...
                          <Input placeholder="Digite seu nome completo" className="text-gray-400 bg-gray-600 border border-gray-500 " {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
